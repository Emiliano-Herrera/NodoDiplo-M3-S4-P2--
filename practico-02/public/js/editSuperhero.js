...
// Estás son mis variables glbales almaceno los datos del heroe a editar...
const superhero = window.superheroe; // datos del heroe
...
function inicializarArrays(){
    // usa un condicional para verificar si existen valores en los array
    // en caso de que si exita usa añadirItem('poderes', poder) donde poder es el valor existente
...
document.getElementById('superheroeForm').addEventListener('submit', async (e) => {
    ...
    if(validarForm()){
        ...
        try {
            // Envia le peticion http al endpoint "/api/actualizarHeroe/id" 
            // y usa el metodo PUT para editar un heroe 
